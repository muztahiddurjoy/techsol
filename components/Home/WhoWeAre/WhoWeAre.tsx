...
const WhoWeAre = () => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 md:px-20 xl:px-20 px-3 md:py-20 py-10 2xl:px-[364px]'>
        <GridContainer image='/enviromen.jpg' link='/company-profile' title="Who we are"  text='A pioneer in manufacturing products, providing solutions and services.'/>
        ...
        <div className="bg-[url('/moner_manush.jpg')] bg-cover p-10 min-h-[270px] relative md:col-span-2 mt-5 mx-3">
          ...
          <Link href="/quality">
            <button className='text-white font-bold rounded-lg p-5 text-3xl md:text-4xl flex items-center'><span className='pr-3'>OUR QUALITY STATEMENT</span></button>
          </Link>
          </div>
