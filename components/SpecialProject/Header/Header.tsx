...
SPECIAL</span> <br />Project</p>
        ...
        <Image src="/maksan.png" height={400} width={600} alt='' className='bottom-0 right-0 2xl:right-32 2xl:bottom-24 absolute w-full md:w-auto px-4 md:pr-10 2xl:pr-[246px]'/>
    </div>
  )
}
